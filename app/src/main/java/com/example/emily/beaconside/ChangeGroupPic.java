...
public class ChangeGroupPic extends AppCompatActivity {
    ...
    private int[] image = {
            R.drawable.group_pic1_s, R.drawable.group_pic2_s, R.drawable.group_pic3_s, R.drawable.group_pic4_s, R.drawable.group_pic5_s
    };
    private String[] imgText = {
            "group_pic1", "group_pic2", "group_pic3", "group_pic4", "group_pic5"
    };
